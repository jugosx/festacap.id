    ...
    $(document).ready(function() {
        ...
        if($('#csi-typed-string').length){
            $('#csi-typed-string').typed({
                strings: ["Among Bahari", "Adiwarna Tradisi","Nguri Uri Ora?"],
                // typing speed
                typeSpeed: 60,
        ...
        if ( $('#csi-countdown').length ) {
            ...
            $('#csi-countdown').countdown(dataTime, function(event) {
                var $this = $(this).html(event.strftime(''
                    ...
                    + '<span class="csi-days">%D <i> Hari </i></span> '
                    + '<span class="csi-hr">%H <i> Jam </i></span> '
                    + '<span class="csi-min">%M <i> Menit </i></span> '
                    + '<span class="csi-sec">%S <i> Detik </i></span>'
                ));
            });
        }
